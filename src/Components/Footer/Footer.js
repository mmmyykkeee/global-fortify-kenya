              ...
              <div className="row">
                <div className="col-xl-4 col-md-4 mb-30">
                  <div className="single-cta mb-3 d-flex">
                    ...
                    <div className="cta-text">
                      <h4>Find us</h4>
                      <span>
                        Global Fortify Financial Planning Consultants and
                        Insurance Agency JKUAT Towers, 17th Floor <br /> P.O Box
                        69888 00400 Nairobi
                      </span>
                    </div>
                  </div>
                ...
                <div className="col-xl-4 col-md-4 mb-30">
                  <div className="single-cta mb-3 d-flex">
                    ...
                    <div className="cta-text">
                      <h4>Call us</h4>
                      <span>Landline: +254 20 515 7067</span> <br />
                      <span>Cell Phone: +254 717 719552</span>
                    </div>
                  </div>
                </div>
                <div className="col-xl-4 col-md-4 mb-30">
                  <div className="single-cta d-flex">
                    ...
                    <div className="cta-text">
                      ...
                      <span>Email: agnes@global-fortify.com</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="col-xl-4 col-lg-4 mb-50">
                  <div className="footer-widget">
                    ...
                    <div className="footer-text">
                      <p>
                        Global Fortify Financial Planning Consultants and
                        Insurance Agency is a highly respected company that
                        specializes in offering financial planning and insurance
                        services to clients around the world. Their team of
                        experts works closely with clients to deliver tailored
                        solutions that meet their specific needs and objectives.
                        The company is committed to transparency, honesty, and
                        integrity.
                      </p>
                    </div>
